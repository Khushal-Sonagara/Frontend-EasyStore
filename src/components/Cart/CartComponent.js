...
function CartComponent() {
    ...
    // return (
    //     <>
    //         <h1 style={{ "textAlign": "center", "margin": "5vh", "color": "#ea9600" }}>Cart</h1>
    //         {data && data.length > 0 ?
    ...
    //                         <td ><button className="button" onClick={() => handleEmptyCart()}>Empty Cart</button></td>
    //                     </tr>
    //                 </thead>
                ...
                <table className="table table-bordered p-5" id='bill-table'>
                    ...
                    <tbody>
                        {data && data.length > 0 ?
                            bill :
                            <tr>
                                <td colSpan="4" className="text-center fw-bold justify-content-center" style={{height:"30vh"}}>No Item Found</td>
                            </tr>
                        }
                    </tbody>
                    <tfoot>
